...
class GraphLayoutExtensionPlaceholder implements ExtensionPlaceholderInterface
{
	...
	public function buildExtension(): ?GraphLayoutExtension
	{
		if ($this->layout != null || $this->layoutOptions !== null) {
			return new GraphLayoutExtension($this->layout, $this->layoutOptions);
		} else {
			return null;
		}
	}
